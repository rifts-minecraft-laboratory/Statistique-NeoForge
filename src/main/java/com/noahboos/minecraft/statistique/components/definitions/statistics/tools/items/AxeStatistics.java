...
public class AxeStatistics extends ToolCore {
    ...
    private static Map<String, Statistic> getDefaultStatistics() {
        ...
        statistics.put(StatisticType.DEWAXED_COPPER_BLOCKS.getName(), StatisticType.DEWAXED_COPPER_BLOCKS.getNewStatistic());
        statistics.put(StatisticType.SCRAPPED_COPPER_BLOCKS.getName(), StatisticType.SCRAPPED_COPPER_BLOCKS.getNewStatistic());
        statistics.put(StatisticType.STRIPPED_LOGS.getName(), StatisticType.STRIPPED_LOGS.getNewStatistic());
        return statistics;
    }
